# Contributing to Beefy broadcast API
...
```
cd beefy-broadcast-api
git remote add upstream https://github.com/beefyfinance/beefy-broadcast-api.git
git fetch upstream
git pull --rebase upstream main
```

NOTE: The directory `beefy-broadcast-api` represents your fork's local copy.
...
4. Go to [github.com/beefyfinance/beefy-broadcast-api](https://github.com/beefyfinance/beefy-broadcast-api) in your web browser and issue a new pull request.
...
If you have any questions, feel free to post them to [github.com/beefyfinance/beefy-broadcast-api/issues](https://github.com/beefyfinance/beefy-broadcast-api/issues).

Finally, if you're looking to collaborate and want to find easy tasks to start, look at the issues we marked as ["Good first issue"](https://github.com/beefyfinance/beefy-broadcast-api/issues?q=label%3A%22good+first+issue%22).
